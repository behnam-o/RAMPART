...
lands, choose an xdist distribution mode based on your tests' fixture and
worker-state requirements, and size your cap to your largest expected worker payload.
